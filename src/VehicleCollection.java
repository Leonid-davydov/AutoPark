...
public class VehicleCollection {
    List<VehicleType> VTCollection;
    List<Vehicle> VCollection;

    VehicleCollection(String typesCSV, String vehiclesCSV, String rentsCSV) {
    ...
    public void display() {
        System.out.println(String.format("%3s %10s %20s %12s %15s %7s %10s %10s %10s %10s %10s",
                "Id", "Type", "ModelName", "Number", "Weight (kg)", "Year", "Millage", "Color", "Income", "Tax", "Profit"));
